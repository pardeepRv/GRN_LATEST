    ...
    if (this.state.entityReceipt.submitStatus == 'processing') {
                  ...
                  <View style={styles.pinkInfoContainer}>
                    ...
                    <Text style={styles.infoText}>
                      {this.state.entityReceipt.quantity -
                        this.state.entityReceipt.changedQuantity}
                    </Text>
                  </View>
                  <View style={styles.greyInfoContainer}>
      ...
      return (
        <View style={styles.container}>
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity style={styles.disableButtonStyle}>
              <View>
                <Text style={styles.buttonText}>CHANGE</Text>
              </View>
            </TouchableOpacity>
      ...
      return (
        <View style={styles.container}>
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity
              onPress={() => {
                this.props.navigation.navigate('GrnChangeReceipt', {
                  entityReceipt: this.state.entityReceipt,
            ...
            <TouchableOpacity
              onPress={() => {
                this.props.navigation.navigate('GrnRejectReceipt', {
                  entityReceipt: this.state.entityReceipt,
                  index: this.state.index,
                });
              }}
